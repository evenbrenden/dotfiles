...

{
  home = {
    file = {
      ".local/share/impulse-responses/lexicon-lxp-1-impulse-responses".source = pkgs.fetchFromGitea {
        domain = "codeberg.org";
        owner = "evenbrenden";
      ...
      ".local/share/midi/instant-midi-drum-patterns".source = pkgs.fetchzip {
      ...
      ".local/share/soundfonts/FluidR3_GM2-2.sf2".source = "${pkgs.soundfont-fluid}/share/soundfonts/FluidR3_GM2-2.sf2";
